...
function Footer() {
    return (
        <>
            <div className="w-full rounded-t-4xl h-64 z-10 flex flex-col justify-start items-center py-5 px-4 bg-gradient-to-br from-orange-400 via-yellow-400 to-emerald-500">
